...
public class NetworkScanner {
    ...
    public static class ScanMatch {
        ...
        public ScanMatch(int x, int y, int z, int dimension, String label) {
            this.x = x;
            this.y = y;
            this.z = z;
    ...
    public static List<ScanMatch> scan(World world, EntityPlayer player, String filter, ItemStack itemFilter,
        int radius) {
        List<ScanMatch> matches = new ArrayList<>();
        if (world == null) return matches;
